...
- (instancetype)init
{
    ...
    if (self) {
        ...
        _titleFont = [UIFont fontWithName:@"Ubuntu-Medium" size:11.0];
        _subtitleFont = [UIFont systemFontOfSize:FSCalendarStandardSubtitleTextSize];
        _weekdayFont = [UIFont fontWithName:@"Ubuntu-Bold" size:15.0];
        _headerTitleFont = [UIFont fontWithName:@"Ubuntu-Bold" size:13.0];
        
        _headerTitleColor = [UIColor colorWithRed:68.0/255.0f green:139.0/255.0f blue:187.0/255.0f alpha:1.0f];
        _headerDateFormat = @"MMMM, yyyy";
        _headerMinimumDissolvedAlpha = 0.2;
        _weekdayTextColor = [UIColor colorWithRed:68.0/255.0f green:139.0/255.0f blue:187.0/255.0f alpha:1.0f];
       ...
       // _calendar.collectionView[@(FSCalendarCellStateSelected)] =
        
        //[UIColor colorWithRed:137.0/255.0f green:217.0/255.0f blue:210.0/255.0f alpha:1.0f];
        ...
        _titleColors[@(FSCalendarCellStateNormal)]      = [UIColor colorWithRed:68.0/255.0f green:138.0/255.0f blue:186.0/255.0f alpha:1.0f];
        _titleColors[@(FSCalendarCellStateSelected)]    = [UIColor colorWithRed:68.0/255.0f green:138.0/255.0f blue:186.0/255.0f alpha:1.0f];
        ...
        _titleColors[@(FSCalendarCellStateToday)]       =   [UIColor colorWithRed:68.0/255.0f green:120.0/255.0f blue:150.0/255.0f alpha:1.0f];
        ...
        _subtitleColors[@(FSCalendarCellStateSelected)]    = [UIColor clearColor];
...
//-(void)setHeaderDateCaps:(NSString *)headerDateCaps {
//    
//}
