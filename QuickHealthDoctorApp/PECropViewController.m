...
- (void)viewDidLoad
{
    ...
    self.navigationController.navigationBar.backgroundColor = [UIColor colorWithRed:19/255.0  green:84/255.0 blue:83/255.0    alpha:1.0];
    
    self.navigationController.navigationBar.barTintColor = [UIColor colorWithRed:0.0/255.0  green:128.0/255.0 blue:128.0/255.0    alpha:1.0];
