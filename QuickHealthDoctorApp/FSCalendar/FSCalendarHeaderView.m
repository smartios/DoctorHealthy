...
- (void)configureCell:(FSCalendarHeaderCell *)cell atIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.titleLabel.text = text.uppercaseString;
    
    if (text != nil){
        NSString *finalText = [text.uppercaseString stringByReplacingOccurrencesOfString:@"," withString:@""];
      cell.titleLabel.attributedText = [self createAttributedText:finalText.uppercaseString fullStringColor:[self colorFromHexCode:@"000000"] subStringColor:[self colorFromHexCode:@"adaeb1"] subString:[finalText.uppercaseString componentsSeparatedByString:@" "][1]];
    }
    [cell setNeedsLayout];
}

//Custom code for attributed string
//Written by - Bhoopendra
- (NSMutableAttributedString *)createAttributedText:(NSString *)fullString fullStringColor:(UIColor *)fullStringColor subStringColor:(UIColor *)subStringColor subString:(NSString *)subString{
    ...
    [attributedString addAttribute:NSForegroundColorAttributeName value:fullStringColor range:NSMakeRange(0, fullString.length)];
    [attributedString addAttribute:NSFontAttributeName value:[UIFont fontWithName:@"OpenSans" size:15.0] range:NSMakeRange(0, fullString.length)];
    [attributedString addAttribute:NSForegroundColorAttributeName value:subStringColor range:range];
    return attributedString;
}

//Custom code for getting color from hex string
//Written by - Bhoopendra
